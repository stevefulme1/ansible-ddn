...
DOCUMENTATION = r"""
---
module: ddn_changelogs
short_description: Manage DDN Lustre changelogs
description:
    - Manage DDN Lustre changelogs.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.ddn.ddn_changelogs:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("changelog_id",))],
    )
