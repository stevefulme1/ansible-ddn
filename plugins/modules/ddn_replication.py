...
DOCUMENTATION = r"""
---
module: ddn_replication
short_description: Manage DDN data replication
description:
    - Manage DDN data replication.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.ddn.ddn_replication:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("replication_id",))],
    )
    ...
    resource_id = module.params.get("replication_id")
